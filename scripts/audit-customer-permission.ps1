...
ORDER BY id;
"@
        $users = Psql -Sql $usersSql -Machine
...
"@
        $memberships = Psql -Sql $membershipsSql -Machine
...
"@
        $roles = Psql -Sql $rolesSql -Machine
...
"@
        $counts = Psql -Sql $countsSql -Machine
...
"@
        $permission = Psql -Sql $permissionSql -Machine
                ...
                try {
                    ...
                    try {
                        ...
                        if (
                            ...
                            $assetCount = @($assetPayload.items).Count
                        }
                    }
                    catch {
