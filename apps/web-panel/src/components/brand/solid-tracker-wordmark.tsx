...
export function SolidTrackerWordmark({
  ...
  const content = (
    <span className="inline-flex items-center whitespace-nowrap">
      ...
      ><span>S</span><MapPin aria-hidden="true" className="solid-marker-o -mr-[4px] ml-0 inline-block h-[0.62em] w-[0.62em] -skew-x-12 align-[-0.005em] text-[#f59a23] stroke-[2.35]" /><span>lid</span></span>
      <span
        className={[
          "font-black italic tracking-[-1.5px]",
          compact ? "text-[22px]" : "text-[31px]",
